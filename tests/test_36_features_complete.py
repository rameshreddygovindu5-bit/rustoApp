...
class TestFrontendVersioning:
    ...
    def test_layout_version_chip_updated(self):
        import re
        with open("../frontend/src/components/Layout/Layout.jsx", encoding="utf-8") as f:
            src = f.read()
        assert "v2.9" in src or "v2.8" in src or "v2." in src, "Version chip missing"

    def test_auth_context_has_role_label(self):
        with open("../frontend/src/context/AuthContext.jsx", encoding="utf-8") as f:
            src = f.read()
    ...
    def test_users_page_has_all_roles(self):
        with open("../frontend/src/pages/Users.jsx", encoding="utf-8") as f:
            src = f.read()
    ...
    def test_security_page_has_otp_section(self):
        with open("../frontend/src/pages/Security.jsx", encoding="utf-8") as f:
            src = f.read()
    ...
    def test_auth_router_has_otp_endpoints(self):
        with open("../backend/app/routers/auth.py", encoding="utf-8") as f:
            src = f.read()
