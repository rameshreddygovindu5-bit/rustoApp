...
class TestFrontendVersioning:
    ...
    def test_layout_version_chip_updated(self):
        import re
        with open("/home/claude/rusto-fix-upload/frontend/src/components/Layout/Layout.jsx") as f:
            src = f.read()
        assert "v2.9" in src or "v2.8" in src or "v2." in src, "Version chip missing"

    def test_auth_context_has_role_label(self):
        with open("/home/claude/rusto-fix-upload/frontend/src/context/AuthContext.jsx") as f:
            src = f.read()
    ...
    def test_users_page_has_all_roles(self):
        with open("/home/claude/rusto-fix-upload/frontend/src/pages/Users.jsx") as f:
            src = f.read()
    ...
    def test_security_page_has_otp_section(self):
        with open("/home/claude/rusto-fix-upload/frontend/src/pages/Security.jsx") as f:
            src = f.read()
    ...
    def test_staff_management_has_otp_toggle(self):
        with open("/home/claude/rusto-fix-upload/frontend/src/pages/StaffManagement.jsx") as f:
            src = f.read()
        assert "require_login_otp" in src, "StaffManagement missing OTP toggle"

    def test_auto_migrate_has_otp_columns(self):
        with open("/home/claude/rusto-fix-upload/backend/app/auto_migrate.py") as f:
            src = f.read()
        assert "login_otp" in src
        assert "require_login_otp" in src

    def test_models_has_new_roles(self):
        with open("/home/claude/rusto-fix-upload/backend/app/models.py") as f:
            src = f.read()
    ...
    def test_auth_router_has_otp_endpoints(self):
        with open("/home/claude/rusto-fix-upload/backend/app/routers/auth.py") as f:
            src = f.read()
